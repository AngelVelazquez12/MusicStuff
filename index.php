...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="PagRegistro.php">Registrate</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="PagIniciar.php">Inicia Sesion</a>
                </li>
            </ul>
        </div>
    </nav>
  ...
  <section align="center">
        <img src="Collage/Bass.png" alt="">
        <img src="Collage/guitar.jpg" alt="">
        <img src="Collage/Igor.jpg" alt="">
        <img src="Collage/Piano.jpg" alt="">
        <img src="Collage/Ukelele.jpg" alt="">
        <img src="Collage/Vinyls.jpg" alt="">
        <img src="Collage/Vol.jpg" alt="">
