...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="SesionMostrar.php">Mostrar Mis Datos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="actions/cerrarSesion.php">Cerrar Sesion</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href=".php">Desactivar Cuenta</a>
                </li>
            </ul>
        </div>
    </nav>
      ...
      <main class="container">
        <h2 class="text-center mt-4">Actualiza tus datos :)</h2>
        <form action="actions/actualizar.php" method="post" class="d-flex flex-column gap-4 form-group w-50 mt-5 mx-auto border p-3">
            ...
            <button type="submit" id="enviar" name="enviar" class="btn btn-secondary">Enviar</button>
        </form>
    </main>
</body>
</html>